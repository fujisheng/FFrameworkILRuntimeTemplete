...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Reflection_Assembly_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("GetExecutingAssembly", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetExecutingAssembly_0);
            args = new Type[]{};
        ...
        static StackObject* GetExecutingAssembly_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);


            var result_of_this_method = System.Reflection.Assembly.GetExecutingAssembly();
